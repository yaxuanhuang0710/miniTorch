...
class Network(minitorch.Module):
    ...
    def __init__(self):
        ...
        self.layer4 = Linear(in_size=64, out_size=10)
    ...
    def forward(self, x):
        ...
        # Apply 2D pooling (either Avg or Max) with 4x4 kernel,Flatten channels, height, and width. (Should be size BATCHx392)
        ...
        x3 = self.layer3.forward(pool).relu()
        if self.mode == "train":
